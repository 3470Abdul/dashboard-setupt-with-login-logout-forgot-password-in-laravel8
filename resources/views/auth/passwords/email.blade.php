										...
										<div class="mb-5 d-flex">
											...
											<div class="wd-100p">
												<div class="main-signin-header">
													...
													<form method="POST" action="{{ url('sendOtp') }}">
														...
														<div class="form-group">
                                                            ...
                                                            <input id="email" type="email" class="form-control @error('email') border-danger is-invalid @enderror" name="email" value="{{ Request::old('email') }}" placeholder="Enter Your Email" autocomplete="email" autofocus required>
                                                            @error('email')
												...
												<div class="main-signup-footer mg-t-20">
													<p>Forget it, <a href="{{ url('login') }}"> Send me back</a> to the login screen.</p>
												</div>
											</div>
										</div>
									</div>
