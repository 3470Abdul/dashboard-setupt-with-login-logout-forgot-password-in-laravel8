											...
											<div class="wd-100p">
												<div class="main-signin-header">
													...
													<form method="POST" action="{{ url('otpVerification') }}">
														...
														<div class="form-group">
															<label>{{ __('Enter 6 digits OTP') }}</label>
                                                            <input id="otp" type="number" class="form-control @error('otp') border-danger is-invalid @enderror" name="otp" value="{{ Request::old('otp') }}" placeholder="Enter 6 digits OTP" autofocus required>
                                                            @error('otp')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
												...
												<div class="main-signup-footer mg-t-20">
													<p>Forget it, <a href="{{ url('password/reset') }}"> Send me back</a> to the forgot password screen.</p>
												</div>
											</div>
										</div>
									</div>
