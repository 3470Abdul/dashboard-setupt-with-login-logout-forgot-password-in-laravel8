                                        ...
                                        <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                            <div class="card-sigin">
                                                <div class="mb-5 d-flex">
                                                    <a href="{{ url('login') }}"><img src="assets/img/brand/favicon.png"
                                                ...
                                                <div class="card-sigin">
                                                    <div class="main-signup-header">
                                                        <h2>Welcome back!</h2>
                                                        <h5 class="fw-semibold mb-4">Please Login to continue.</h5>
                                                        ...
                                                        <form method="POST" action="{{ route('login') }}">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="email" type="email" class="form-control @error('email') border-danger is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Enter Your Email" autofocus>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="password" type="password" class="form-control @error('password') border-danger is-invalid @enderror" name="password" placeholder="Enter Your Password" required autocomplete="current-password">
                                                        ...
                                                        <div class="main-signin-footer mt-5">
                                                            ...
                                                            <p>Don't have an account? <a href="{{ url('register') }}">Create an
                                                                    Account</a></p>
                                                        </div>
                                                    </div>
                                                </div>
