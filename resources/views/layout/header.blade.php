							...
							<ul class="nav nav-item  navbar-nav-right ms-auto">
								...
								<li class="dropdown main-profile-menu nav nav-item nav-link">
									...
									<div class="dropdown-menu">
										...
										<a class="dropdown-item" href="check-out.html"><i class="bx bx-slider-alt"></i> Account Settings</a>
				...
				<div class="sticky">
					<aside class="app-sidebar sidebar-scroll">
						<div class="main-sidebar-header active">
							<a class="desktop-logo logo-light active" href="{{ url('/home') }}"><img src="assets/img/brand/logo.png" class="main-logo" alt="logo"></a>
							<a class="desktop-logo logo-dark active" href="{{ url('/home') }}"><img src="assets/img/brand/logo-white.png" class="main-logo" alt="logo"></a>
							<a class="logo-icon mobile-logo icon-light active" href="{{ url('/home') }}"><img src="assets/img/brand/favicon.png" alt="logo"></a>
							<a class="logo-icon mobile-logo icon-dark active" href="{{ url('/home') }}"><img src="assets/img/brand/favicon-white.png" alt="logo"></a>
						</div>
						<div class="main-sidemenu">
							<div class="app-sidebar__user clearfix">
								<div class="dropdown user-pro-body">
									...
									<div class="user-info">
										<h4 class="fw-semibold mt-3 mb-0">Admin Admin</h4>
							...
							<ul class="side-menu">
								...
								<li class="slide">
									<a class="side-menu__item" href="{{ url('/home') }}"> <span class="side-menu__label"><i class="fas fa-tachometer-alt me-3"></i> Dashboard</span></a>
								</li>
                                <li class="slide">
									<a class="side-menu__item" href="{{ url('/users') }}">
                                         <span class="side-menu__label"><i class="fa-solid fa-users me-3"></i> Users</span></a>
								</li>
                                <li class="slide">
									<a class="side-menu__item" href="{{ url('/text') }}">
                                         <span class="side-menu__label"><i class="fa-solid fa-users me-3"></i> Text</span></a>
								</li>
							</ul>
